...
if ($Target.Equals("Debug")) {
    ...
    if (Test-Path -Path "$TargetPath\Newtonsoft.Json.dll") {
        Write-Host "Copy Newtonsoft.Json.dll to $plug"
        Copy-Item -Path "$TargetPath\Newtonsoft.Json.dll" -Destination "$plug" -Force
    }
}
